#Developed by github.com/FemellesV1
#This script was made for educational purposes. I am not responsible for your actions.
...
ascii_text = f"""{Fore.RED}
  _____ _ _   _____    _    __   ___            ___      _   
 |_   _(_) |_|_   _|__| |__ \ \ / (_)_____ __ _| _ ) ___| |_ 
   | | | | / / | |/ _ \ / /  \ V /| / -_) V  V / _ \/ _ \  _|
   |_| |_|_\_\ |_|\___/_\_\   \_/ |_\___|\_/\_/|___/\___/\__|
...
{self.console_msg("4")} Share Bot {Fore.RED}{self.status["shares"]}
    ...
    def update_title(self, bot, remaining, rl = False):
        if clear == "cls":
            os.system(clear)
            ctypes.windll.kernel32.SetConsoleTitleW(f"TikTok AIO | Sent: {self.sent} | Cooldown: {remaining}s | Developed by Femelles")
            print(ascii_text)
    ...
    def main(self):
        if clear == "cls":
            ctypes.windll.kernel32.SetConsoleTitleW("TikTok Views/Shares/Likes bot | Developed by Femelles")
